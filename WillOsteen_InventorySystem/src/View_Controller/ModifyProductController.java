...
public class ModifyProductController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        productIDField.setPromptText(Integer.toString(productToModify.getProductID()));
        productNameField.setText(productToModify.getProductName());
        productInvField.setText(Integer.toString(productToModify.getProductInStock()));
    ...
    void saveProduct(ActionEvent event) {
        ...
        int productID = productToModify.getProductID();
        ...
        if (!failConditions) {
            ...
            Inventory.updateProduct(productToModify.getProductID(),product);
        }
